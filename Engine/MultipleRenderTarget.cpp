...
{
	D3D12_VIEWPORT vp = D3D12_VIEWPORT{ 0.f, 0.f, mRtVec[0].target->GetWidth(),mRtVec[0].target->GetHeight(), 0.f, 1.f };
	D3D12_RECT rect = D3D12_RECT{ 0, 0, static_cast<LONG>(mRtVec[0].target->GetWidth()), static_cast<LONG>(mRtVec[0].target->GetHeight()) };
